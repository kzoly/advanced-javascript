import { GenericListComponent } from './generic-todo/generic-todo-component.mjs';
import { GenericListStore } from './generic-todo/generic-todo-store.mjs';
...
const tableConfig = {
    ...
    const tableStore = new GenericListStore(tableConfig);

    // initialize the table component
    const cmp = new GenericListComponent(tableStore);
